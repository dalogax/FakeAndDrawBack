	...
	public MessagePayload getMessagePayload(){
		...
		switch(MessageType.findByType(this.type)) {
			case CREATE_GAME:
				...
				break;
			case GAME_CREATED:
				messagePayload = new ObjectMapper().convertValue(this.payload, GameCreatedMessagePayload.class);
				break;
			case NEW_USER:
				messagePayload = new ObjectMapper().convertValue(this.payload, NewUserMessagePayload.class);
				break;
			case USER_ADDED:
				messagePayload = new ObjectMapper().convertValue(this.payload, UserAddedMessagePayload.class);
				break;
		}
